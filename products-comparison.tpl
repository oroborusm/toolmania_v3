				...
				{foreach from=$products item=product name=for_products}
					...
					<td class="ajax_block_product comparison_infos product-block product-{$product->id}">
						...
						<div class="product-image-block">
							...
							<a class="Otroquick-view" href="{$product->getLink()|escape:'html':'UTF-8'}" title="{l s='View'}">
								<span>{l s='View'}</span>
							</a>
						</div> <!-- end product-image-block -->
						<div class="tituloComparacion">
							<h5>
...
<p class="navegador">
	<a class="checkout" href="{$base_dir}">
		<span><span class="icon-chevron-right"></span>{l s='Continue Shopping'}</span>
	</a>
