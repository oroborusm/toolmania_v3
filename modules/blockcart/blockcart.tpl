...
{/if}
	<div class="carritoHover">
		<div class="carritoDeCompra shopping_cart">
			<!-- <a class="goCarrito" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			{if !$PS_CATALOG_MODE && $active_overlay == 1}
				<div id="layer_cart" class="capaCarrito">
					
						<div class="productoCarrito">
							<span title="{l s='Close window' mod='blockcart'}"></span>
							<!-- <h2>
								<i></i>{l s='Product successfully added to your shopping cart' mod='blockcart'}
							</h2> -->
							<div class="carritoImagenCont">
							</div>
							<!-- <div class="total">
